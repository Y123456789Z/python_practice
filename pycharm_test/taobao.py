...
response=req.get('https://re.taobao.com/search?refpid=420435_1006&keyword=%E8%BF%90%E5%8A%A8%E8%A3%85+%E7%94%B7&_input_charset=utf-8&page=',headers=headers)
'''
...
def getInfo(page):
    ...
    url_men = "https://re.taobao.com/search?refpid=420435_1006&keyword=%E8%BF%90%E5%8A%A8%E8%A3%85+%E7%94%B7&_input_charset=utf-8&page=" + str(
        page) + "&isinner=0&rewriteKeyword"
    ...
    for i in range(len(titles)):
        ...
        writer.writerow((titles[i].get_text(), prices[i].find('strong').get_text(), shops[i].get_text(),
                         ''.join(saleNum), appraise[i].get_text()))
